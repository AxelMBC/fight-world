...
const topFightersData = ({ topFightersData }: topFightersType) => {
  return (
    <section className="mb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        <div className="lg:col-span-2">
          {topFightersData[0] && <FighterCard boxer={topFightersData[0]} rank={1} />}
        </div>
        <div className="md:col-span-1">
          {topFightersData[1] && <FighterCard boxer={topFightersData[1]} rank={2} />}
        </div>
